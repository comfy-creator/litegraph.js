...
*/
    ...
    LGraphNode.prototype.addOnTriggerInput = function () {
        ...
        if (trigS == -1) {
            //!trigS ||
            let input = this.addInput("onTrigger", LiteGraph.EVENT, {
                optional: true,
                nameLocked: true,
            });
    ...
    LGraphNode.prototype.addOnExecutedOutput = function () {
        ...
        if (trigS == -1) {
            //!trigS ||
            let output = this.addOutput("onExecuted", LiteGraph.ACTION, {
                optional: true,
                nameLocked: true,
            });
    ...
    LGraphNode.prototype.findInputSlotFree = function (optsIn) {
        optsIn = optsIn || {};
        let optsDef = { returnObj: false, typesNotAccepted: [] };
    ...
    LGraphNode.prototype.connectByType = function (
        ...
        let target_slot = target_node.findInputSlotByType(
            target_slotType,
            false,
            true
        );
        if (target_slot >= 0 && target_slot !== null) {
            ...
            if (
                ...
                let target_slot = target_node.findInputSlotFree({
    ...
    LGraphNode.prototype.connectByTypeOutput = function (
        ...
        let source_slot = source_node.findOutputSlotByType(
            source_slotType,
            false,
            true
        );
        if (source_slot >= 0 && source_slot !== null) {
            ...
            if (
                ...
                let source_slot = source_node.findOutputSlotFree({
                    typesNotAccepted: [LiteGraph.EVENT],
                });
                if (source_slot >= 0) {
                    return source_node.connect(source_slot, this, slot);
	...
	*/
    ...
    LGraphCanvas.prototype.processNodeWidgets = function (
        ...
        for (let i = 0; i < node.widgets.length; ++i) {
            ...
            let widget_height = w.computeSize
    ...
    LGraphCanvas.onMenuAdd = function (node, options, e, prev_menu, callback) {
        ...
        function inner_onMenuAdded(base_category, prev_menu) {
            let categories = LiteGraph.getNodeTypesCategories(
            ...
            categories.map(function (category) {
                ...
                let base_category_regex = new RegExp(
                    "^(" + base_category + ")"
                );
            ...
            let nodes = LiteGraph.getNodeTypesInCategory(
        ...
        function refreshHelper() {
            ...
            if (that.onSearchBox) {
                ...
                if (options.do_type_filter && that.search_box) {
                    let sIn = that.search_box.querySelector(
                        ".slot_in_type_filter"
                    );
                    let sOut = that.search_box.querySelector(
    ...
    LGraphCanvas.prototype.createPanel = function (title, options) {
        ...
        root.addWidget = function (type, name, value, options, callback) {
            ...
            if (type == "code")
                ...
                let str_value = LGraphCanvas.getPropertyPrintableValue(
                    value,
                    options.values
                );
                value_element.innerText = str_value;
            ...
            let fUpdate = function (name, value) {
                ...
                switch (name) {
                    case "Title":
                        ...
                        break;
                    case "Mode":
                        let kV = Object.values(LiteGraph.NODE_MODES).indexOf(
                            value
                        );
    ...
    LGraphCanvas.prototype.showSubgraphPropertiesDialog = function (node) {
        ...
        let panel = this.createPanel("Subgraph Inputs", {
            closable: true,
            width: 500,
        });
        panel.node = node;
    ...
    LGraphCanvas.prototype.showSubgraphPropertiesDialogRight = function (node) {
        ...
        if (old_panel) old_panel.close();
        // new panel
        let panel = this.createPanel("Subgraph Outputs", {
            closable: true,
            width: 500,
        });
        panel.node = node;
